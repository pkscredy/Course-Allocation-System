...
public class HODLoginActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				{
					Toast.makeText(HODLoginActivity.this,"Fill All The Details",Toast.LENGTH_SHORT).show();
				}
				else
				{
	...
	public class BackTask extends AsyncTask<String,Void, String>
	{
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
		info_url="http://192.168.0.102:80/callot/hodlogin.php";
		}
		@Override
		...
		{
			Intent intent=new Intent(HODLoginActivity.this,HODMainActivity.class);
		...
		{
			Toast.makeText(HODLoginActivity.this,"Authentication Fails",Toast.LENGTH_SHORT).show();
		}
